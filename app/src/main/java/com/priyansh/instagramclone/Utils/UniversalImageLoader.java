...
public class UniversalImageLoader {
    ...
    /**
     * This method can be used to set image in imageView that are static. It can't be used if the
     * images are being changed in Fragment/Activity i.e. Dynamic OR if they are being set in a list
     * or a grid
     * @param imgURL
     * @param imageView
     * @param mProgressBar
